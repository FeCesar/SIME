...
<html lang="en">
  ...
  <body>
    ...
    <article style="background-color: #e9ecef; width: 100%;">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb container">
                ...
                <li class="breadcrumb-item active">Menu de Cadastros de Usuários</li>
            </ol>
        </nav>
    </article>
    ...
    <main class="container main">
        ...
        <a href="cadastrarusers/cadastrarprofessor.php"><div class="box">
            <h3 class="font-weight-light">Professores</h3>
        </div></a>
    </main>
