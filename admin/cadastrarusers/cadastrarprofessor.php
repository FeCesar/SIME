    ...
    <article style="background-color: #e9ecef; width: 100%;">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb container">
                ...
                <li class="breadcrumb-item active">Cadastrar Professores</li>
            </ol>
        </nav>
    </article>
    ...
    <aside>
      ...
      <?php if(isset($_SESSION['success_insercao'])): ?>
          <div class="alert alert-success container-fluid" style="font-size: 12px; display: inline-block;" role="alert">
            <p class='container' style='padding: 0; margin-bottom:0;'>Cadastro de Professor Concluído!</p>
          </div>
      <?php endif; unset($_SESSION['success_insercao']); ?>
    </aside>

    <main class="container">
      <form method="post" action="scriptsphp/cadastroprofessor.php">
        <div class="form-row">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="inputEmail4" placeholder="Ex.: Química" name='materia' required>
          </div>
