...
<html lang="en">
  ...
  <body>
    ...
    <aside>
      ...
      <?php if(isset($_SESSION['error_numero_rm_invalido'])): ?>
            <div class="alert alert-danger container-fluid" style="font-size: 12px; display: inline-block;" role="alert">
              <p class='container' style='padding: 0; margin-bottom:0;'>RM inválido!</p>
            </div>
      <?php endif; unset($_SESSION['error_numero_rm_invalido']); ?>
      <?php if(isset($_SESSION['success_insercao'])): ?>
          <div class="alert alert-success container-fluid" style="font-size: 12px; display: inline-block;" role="alert">
            <p class='container' style='padding: 0; margin-bottom:0;'>Cadastro de Aluno Concluído!</p>
          </div>
        <?php endif; unset($_SESSION['success_insercao']); ?>
    </aside>

    <main class="container">
        <form action="scriptsphp/cadastroaluno.php" method="post">
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="inputEmail4">Nome Aluno</label>
        ...
        <div class="form-row">
                <div class="form-group col-md-2">
                    <label for="inputZip">Sala do Aluno</label>
                    <input type="text" class="form-control" id="inputZip" placeholder="Ex.: 3ºB" name="sala">
                </div>
                <div class="form-group col-md-2">
                    <label for="inputZip">Idade do Aluno</label>
                    <input type="text" class="form-control" id="inputZip" placeholder="Ex.: 17" name="idade">
                </div>
                <div class="form-group col-md-4">
                <label for="inputState">Série</label>
                <select id="inputState" class="form-control" name="serie">
                    <option selected value="1">1º Série</option>
