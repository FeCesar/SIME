...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="styles/painel-usuario-admin.css">
  ...
  <body>
    ...
    <main class="container main">
        <a href="criaroficina.php"><div class="box" name="no_margin_left">
            <h3 class="font-weight-light">Criar Oficina</h3>
        </div></a>
        <a href="gerenciaroficina.php"><div class="box">
            <h3 class="font-weight-light">Gerenciar Oficinas</h3>
        </div></a>
        <a href="cadastrarusuarios.php"><div class="box">
            <h3 class="font-weight-light">Cadastrar Usuário</h3>
        </div></a>
    </main>
